                ...
                <section class="p-0 box-contenido-seleccion">
                    <div class="row g-0 justify-content-center">
                        ...
                        <div class="col-12 col-md-8">
                            ...
                            <p class="text-title-select fw-medium fs-20 line-height-20 mt-3 mb-3 element-no-paquete">Convenio*</p>
                            <div class="mb-3 box-btn-convenio element-no-paquete">
                                <button class="btn disabled bg-white-80 w-100 btn-sm btn-outline-primary-veris waves-effect d-flex justify-content-between align-items-center pt-3 pb-3 border-1" type="button" data-bs-toggle="modal" data-bs-target="#convenioModal" id="btn-convenio" data-rel="">
                                    <p class="fs-20 line-height-20 line-height-16 fw-medium mb-0 text-truncate"></p>
                            ...
                            <p class="text-title-select fw-medium fs-20 line-height-20 mt-3 mb-3 item-presencial">Ciudad*</p>
                            <div class="mb-1 box-btn-ciudad item-presencial">
                                <button class="btn disabled bg-white-80 w-100 btn-sm btn-outline-primary-veris waves-effect d-flex justify-content-between align-items-center pt-3 pb-3 border-1" type="button" data-bs-toggle="modal" data-bs-target="#ciudadModal" id="btn-ciudad" data-rel="">
                                    <p class="fs-20 line-height-20 line-height-16 fw-medium mb-0"></p>
                            ...
                            <p class="text-title-select fw-medium fs-20 line-height-20 mt-3 mb-3 element-no-paquete">Especialidad*</p>
                            <div class="mb-3 box-btn-especialidad element-no-paquete">
                                <button class="btn disabled bg-white-80 w-100 btn-sm btn-outline-primary-veris waves-effect d-flex justify-content-between align-items-center pt-3 pb-3 border-1" type="button" data-bs-toggle="modal" data-bs-target="#especialidadModal" id="btn-especialidad" data-rel="">
                                    <p class="fs-20 line-height-20 line-height-16 fw-medium mb-0">Seleccionar</p>
                            ...
                            <p class="text-title-select fw-medium fs-20 line-height-20 mt-3 mb-3 item-presencial">Central médica*</p>
                            ...
                            <button id="btn-continuar" class="btn btn-lg btn-primary-veris w-100 px-4 py-3 fs-25 mt-4">{{ __('Continuar') }}</button>
                        </div>
                    </div>
                </section>
            </div>
...
<script>
    ...
    async function validarCondicionConvenio(){
        ...
        let args = [];
        args["endpoint"] = api_url_digitales + `/${api_war_digitales}/comercial/validaCondicionConvenio?canalOrigen=${_canalOrigen}&esValidacionLink=false&codigoEmpresa=1&codigoConvenio=${(dataCita.convenio.codigoConvenio != null) ? dataCita.convenio.codigoConvenio : ''}${paramasAditional}`;
        args["method"] = "GET";
        args["showLoader"] = true;
        const data = await call(args);
        if(data.code == 200){
    ...
    async function consultarCiudades() {
        let args = [];
        args["endpoint"] = api_url_digitales + `/${api_war_digitales}/agenda/ciudades?canalOrigen=${_canalOrigen}&codigoEmpresa=1&excluyeVirtual=true&idPaciente=${dataCita.paciente.numeroPaciente}`;
        args["method"] = "GET";
    ...
    async function consultarCentralesMedicasRecomendadas(){
        let args = [];
        args["endpoint"] = api_url_digitales + `/${api_war_digitales}/agenda/listado/centrosMedicos?canalOrigen=${_canalOrigen}&codigoEmpresa=1&codigoCiudad=${dataCita.ciudad.codigoPais+'-'+dataCita.ciudad.codigoProvincia+'-'+dataCita.ciudad.codigoCiudad}&idPaciente=${dataCita.paciente.numeroPaciente}`;
        args["method"] = "GET";
        args["showLoader"] = true;
        const data = await call(args);
        if(data.code == 200){
    ...
    async function consultarSiEsTratamiento(){
        ...
        let args = [];
        args["endpoint"] = api_url_digitales + `/${api_war_digitales}/tratamientos/obtener_tratamiento_compatible?canalOrigen=${_canalOrigen}&codigoEmpresa=1&online=${dataCita.online}&idPaciente=${dataCita.paciente.numeroPaciente}
